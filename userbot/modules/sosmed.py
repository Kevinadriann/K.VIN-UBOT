# ported from Man-Userbot <https://github.com/mrismanaziz/Man-Userbot/>
# 
# Recode by Izzy punya Iraa
#
# Nyenyenye bacot
    ...
    async with event.client.conversation(chat) as conv:
        try:
            response = conv.wait_event(
                events.NewMessage(incoming=True, from_users=5061523020)
            )
...
CMD_HELP.update(
    {
        ...
        \n\n  •  **Syntax :** `.sosmed` <link>\
        \n  •  **Function : **Download Media Dari Pinterest / Instagram.\
        \n\n  •  **Syntax :** `.tiktok` <link>\
        \n  •  **Function : **Download media dari tiktok\
    "
    }
)